...
Sequence_Data_3:				'Cycle Time Counter for QoS calculation
 inc time					'Bump up the nominal 'tme' counter variable by one count
 b9 = "C"					'Tx data
 w0 = time
 gosub RF_Tx:
...
Lo_Ra_Tx:
 ...
 for b0 = 1 to 13	 					'Power Save pause for a few seconds
  'serout 0,N2400_16,(13,10,#b0)			'Debug script send pre data
